<?php include '..\src\navbar.php' ?>
  ...
  <h1>Selecciona una emoción para tu cuento</h1>
    ...
    <div class="div-btn-back-emociones">
      <button type="submit" class="btn-back-emociones">
        <svg class ="svg-back-emociones" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="m11.25 9-3 3m0 0 3 3m-3-3h7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        </svg>Atras          
       </button>
         </div>

         <div class="div-btn-next-emociones">
          <button type="submit" class="btn-next-emociones">Continuar
                <svg class="svg-next-emociones" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
